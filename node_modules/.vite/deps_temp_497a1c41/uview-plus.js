...
function syncThemeToH5(mode) {
  if (typeof document !== "undefined" && document.documentElement) {
    ...
    const bg = color_default.bgColor || (mode === "dark" ? "#1f1f1f" : "#f3f4f6");
...
function applyNativeThemeUI2(mode, themeColors) {
  var _a, _b;
  if (typeof uni === "undefined")
    return;
  const isDark = normalizeThemeMode2(mode) === "dark";
  const pageBg = (themeColors == null ? void 0 : themeColors.bgColor) || (isDark ? "#1f1f1f" : "#f3f4f6");
  const navBg = ((_a = config_default.color) == null ? void 0 : _a["up-navbar-bg-color"]) || ((_b = config_default.color) == null ? void 0 : _b["u-navbar-bg-color"]) || (isDark ? "#1c1c1e" : "#ffffff");
...
function applyTheme(mode = "light") {
  ...
  applyNativeThemeUI2(themeMode, themeColors);
